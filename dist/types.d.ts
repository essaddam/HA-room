...
export type CardAction = NavigateActionConfig | MoreInfoActionConfig | CallServiceActionConfig | PerformActionConfig | {
    action: 'none';
} | {
    action: string;
};
...
export declare function isPerformAction(action: CardAction): action is PerformActionConfig;
